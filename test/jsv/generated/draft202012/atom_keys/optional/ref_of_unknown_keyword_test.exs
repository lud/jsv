...
defmodule JSV.Generated.Draft202012.AtomKeys.Optional.RefOfUnknownKeywordTest do
  ...
  describe "reference of a root arbitrary keyword with encoded ref" do
    setup do
      json_schema = %{
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        properties: %{bar: %JSV.Schema{"$ref": "#/unknown~1keyword"}},
        "unknown/keyword": %JSV.Schema{type: "integer"}
      }
  ...
  describe "reference of an arbitrary keyword of a sub-schema with encoded ref" do
    setup do
      json_schema = %JSV.Schema{
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        properties: %{
          bar: %JSV.Schema{"$ref": "#/properties/foo/unknown~1keyword"},
          foo: %{"unknown/keyword": %JSV.Schema{type: "integer"}}
        }
      }
